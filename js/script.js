...
function activeItemNav() {
  menuItem.forEach((item) => item.classList.remove("activeNAV"));
  this.classList.add("activeNAV");
}

menuItem.forEach((item) => item.addEventListener("click", activeItemNav));
...
checkboxDarkMode.addEventListener("click", () => {
  if (checkboxDarkMode.checked == true) {
    ...
    document.querySelector(
      ".clound"
    ).innerHTML = `<img class="animate__animated animate__fadeInLeft clound-left animate__delay-1s" src="https://res.cloudinary.com/dvzingci9/image/upload/v1652852065/My-portfolio/clound-moon-left_jaocus_optimized_dmjzjr.png" alt="">
    ...
    // circle
    document.querySelector(".skill .skill-container img").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652458965/My-portfolio/picVAP-dark_qeqodg.png";
    ...
    document.querySelector(".about .row-1 .content img").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652845802/My-portfolio/dc2-dark_optimized_bi839d.png";

    // project-border-left
    document.querySelector(".project__border__left").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652450175/My-portfolio/project-dark_uq99k2.png";

    // bg__fav__cover
    document.querySelector(".bg__fav__cover").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652458479/My-portfolio/bg_fav_cover-dark_q0xovc.png";
    ...
    document.querySelector(
      ".clound"
    ).innerHTML = `  <img class="animate__animated animate__fadeInLeft clound-left animate__delay-1s" src="https://res.cloudinary.com/dvzingci9/image/upload/v1652802792/My-portfolio/clound-left_optimized_xjoubm.png" alt="">
...
`;
    ...
    // about taget
    document.querySelector(".about .row-1 .content img").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652300891/My-portfolio/dc2_wquo4x.png";

    // project-border-left
    document.querySelector(".project__border__left").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652300902/My-portfolio/project_border_ofqone.png";

    // bg__fav__cover
    document.querySelector(".bg__fav__cover").src =
      "https://res.cloudinary.com/dvzingci9/image/upload/v1652856357/My-portfolio/bg_fav_cover_optimized_z38zzf.png";
  }
});
